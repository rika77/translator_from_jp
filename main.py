...
from encoder_class import EncoderRNN
from decoder_class import DecoderRNN
from attn_decoder_class import AttnDecoderRNN
...
## Evaluate by Bleu
lines = open('data/for_test.txt', encoding='utf-8').read().strip().split('\n')
test_pairs = [[s for s in l.split('\t')] for l in lines]
